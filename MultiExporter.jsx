...
var nyt_png_exporter = {
  ...
  load_prefs: function () {
    ...
    try {
      ...
      saved_data.appendChild(new XML('<nyt_jpg_quality>80</nyt_jpg_quality>'));
    ...
    if (this.png_info_lyr.textFrames.length != 1) {
      ...
      try {
        ...
        if (this.prefs_xml.nyt_jpg_quality && this.prefs_xml.nyt_jpg_quality != '') {
          this.jpg_quality = this.prefs_xml.nyt_jpg_quality;
        } else {
          this.jpg_quality = 80;
        }
  ...
  show_dialog: function () {
    ...
    transPnl.jpgQualityLabel = transPnl.add('statictext', undefined, 'JPG Quality');
    var jpgQualityEt = transPnl.add('edittext', undefined, this.jpg_quality);
    jpgQualityEt.size = [50, 20];
    ...
    btnPnl.cancelBtn.onClick = function () {
      nyt_png_exporter.dlg.close()
    };

    // OK button
    btnPnl.okBtn = btnPnl.add('button', undefined, 'Export', {
      name: 'ok'
    });
    btnPnl.okBtn.onClick = function () {
      ...
      nyt_png_exporter.jpg_quality = parseFloat(jpgQualityEt.text);
  ...
  run_export: function () {
    ...
    this.prefs_xml.nyt_jpg_quality = this.jpg_quality;
